...
enum ShaderBinaryFormat { SHADER_BINARY_FORMAT_SPIR_V };
...
enum DescriptorType {
    ...
    DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER,    // samplerbuffer	(access to buffer texture,can only be accessed with
                                           // texelFetch function) ,textureBuffer(vulkan)
...
GLenum Map(ImageAspectFlagBits imageApsect);
